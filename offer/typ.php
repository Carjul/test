<?php
// Leer de parámetros GET en lugar de sesión
$redirectUrl = isset($_GET['redirectUrl']) ? urldecode($_GET['redirectUrl']) : '';
$nameMarca = isset($_GET['nameMarca']) ? urldecode($_GET['nameMarca']) : '';
...
<meta content="Dankeseite mit Countdown und Einzahlungserinnerung." name="description"/>
...
<h1 class="text-2xl font-bold text-white">Ihre Bewerbung wurde erfolgreich eingereicht!</h1>
<p class="mt-2 text-blue-200">Vielen Dank für Ihre Bewerbung.</p>
</div>
<!-- Countdown section -->
<div class="px-6 py-8">
<div class="text-center mb-6">
<p class="text-gray-600 mb-4">Einer unserer erfahrenen Geschäftsberater wird Sie in Kürze durch den Onboarding-Prozess begleiten:</p>
...
<p class="text-gray-500 italic mb-6" id="end-msg">Alles ist für Sie bereit...</p>
</div>
<!-- Deposit reminder -->
...
<div class="ml-3">
<p class="text-sm text-gray-700">Zur Eröffnung eines neuen Kontos ist eine Mindesteinzahlung von<span class="font-bold text-blue-600"> 250 €</span>erforderlich.</p>
</div>
</div>
</div>
<!-- Next steps -->
...
<script>
      ...
      const countdown = setInterval(() => {
        ...
        if (timeLeft <= 0) {
          ...
          endMsgElement.textContent = "Ihr Konto ist bereit!";
